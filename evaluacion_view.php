  ...
  <?php if ($resultado): ?>
    ...
    <div class="p-5">
      ...
      <div class="flex gap-3 flex-wrap">
        ...
        <a href="generador.php?id=<?= $idPaciente ?>" class="brand-bg text-white text-sm font-semibold px-4 py-2.5 rounded-lg hover:opacity-90">Generar plan con este GET</a>
